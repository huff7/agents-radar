...
// Create provider lazily - will use LLM_PROVIDER env var
let _provider: LlmProvider | undefined;

function getProvider(): LlmProvider {
  // Always create a new provider to ensure LLM_PROVIDER env var is respected
...
const LLM_CONCURRENCY = 1;  // 降低到1以避免速率限制
